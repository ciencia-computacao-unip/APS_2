...
var hash = crypto.createHash('sha256').update(hash_descriptografada).digest('base64'); //gera a hash. Isso irá criptografar a mensagem --> incompatibilidade com o PHP - ainda comprime em base64
